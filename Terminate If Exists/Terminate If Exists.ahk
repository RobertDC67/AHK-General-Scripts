...
; ∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙ 
	OPTION 2 - Close With Hotkey
; ∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙ 
TargetProcess1 := "Program.exe" 	 ; Change to wanted program.
;;------------------------ 
^F3::
    If (ProcessExist(TargetProcess1)) { 	 ; Checks if the process is running.
        Process, Close, %TargetProcess1% 	 ; If it is running, terminates the process.
    Soundbeep, 1500, 100 		 ; Remove if not wanted.
        } 
Return
;;------------------------ 
ProcessExist(Name){
