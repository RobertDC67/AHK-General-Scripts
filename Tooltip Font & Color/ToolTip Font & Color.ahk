...
» v1.003 - Added workarounds for ToolTip's parameter being∙∙∙
    ∙∙∙overwritten by code within the message hook.
» v1.004 - Fixed text color.
» 
✱ SOURCE :  https://www.autohotkey.com/boards/viewtopic.php?f=6&t=4777
∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙ 
;∙---------------------- NOTES END ----------------------------------------∙ 
*/
; ∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙ 
...
ToolTip ToolTip with Customized Combined Font and Color 
Sleep 5500
