...
fish := ["Convict", "Jack Dempsey", "Blue Ram", "Jewel", "Discus", "Texas"]
...
^5::
^6::
    Send % "{Text}" fish[SubStr(A_ThisHotkey, 0)] " Cichlid`n"
Return
...
While, fish[A_Index]
	Hotkey, ^%A_Index%, :X:🐟
:X:🐟::Send % "{Text}" fish[SubStr(A_ThisHotkey, 0)] " Cichlid`n"
...
For 🐟 in fish := ["Convict", "Jack Dempsey", "Blue Ram", "Jewel", "Discus", "Texas"]
	Hotkey, ^%🐟%, :X:🐟
:X:🐟::Send % "{Text}" fish[SubStr(A_ThisHotkey, 0)] " Cichlid`n"
