...
while (GetKeyState("Ctrl", "P"))    ; Loop until Ctrl key is released.
    {
    if (GetKeyState("", "P"))    ; Check if T key is pressed during the loop.
    {
        SoundBeep, 1800, 100
    }
        Sleep 50    ;; Add delay to reduce CPU usage.
    }

MsgBox,,, The CTRL key`nWas Released, 2
