...
/*
;;-------------- Notes
Send different commands with 1 hotkey.
• 1st time pressing Shift + Space = send command Shift + Space, M
• 2nd time pressing Shift + Space = send command Shift + Space, W
*/


;;-------------- 1 Key - 2 triggers
~+Space::Send % (On := !On) ? "M" : "W"
