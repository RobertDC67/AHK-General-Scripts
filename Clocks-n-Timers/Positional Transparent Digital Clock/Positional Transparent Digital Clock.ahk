...
;;∙------∙Define variables.
GuiWidth := 130
Xpos := (A_ScreenWidth - GuiWidth)    ;;∙------∙Right edge of screen.
Ypos := (A_ScreenHeight - 80)    ;;∙------∙80 pixels above bottom edge of screen.

OldTime := ""

fontName := "Calibri"
fontSize := 17
fontShadowColor := "101010"    ;;∙------∙Shadowing color.
fontColor := "2185E9"    ;;∙------∙Light Blue



;;∙------∙Setup GUI.
Gui, +AlwaysOnTop -Caption +LastFound +ToolWindow
Gui, Color, %fontShadowColor%
Gui, Font, q5 s%fontSize%, %fontName%

;;∙------∙XX:XX:XX serves to auto-size the window.
 Gui, Add, Text, vMyTime1 c%fontColor%, XX/XX/XX   XX:XX

;;∙------∙Make all pixels of this color transparent and make the text itself translucent (150).
WinSet, TransColor, %fontShadowColor% 233

SetTimer, UpdateClock, 50
Gosub, UpdateClock    ;;∙------∙Make the first update immediate rather than waiting for the timer.

Gui, Show, x%Xpos% y%Ypos% w%GuiWidth% NoActivate  
    enableGuiDrag()    ;;∙------∙Make draggable.
Return
