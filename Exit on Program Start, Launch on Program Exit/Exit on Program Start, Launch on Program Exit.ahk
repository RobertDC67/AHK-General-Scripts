...
APP := "Program.exe"    ;; Enter wanted... program.exe ...between the quotes.
SCR := "TargetScript.ahk"    ;; Enter your... ScriptName.ahk ...(or the Full script address in not in the same folder location) between the quotes.

;;  **  Example **
;;  APP := "SMPlayer.exe"
;;  SCR := "C:\Users\UserName\Downloads\Auto Hot Key\Volume.ahk"
