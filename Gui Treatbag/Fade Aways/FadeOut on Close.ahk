...
DllCall("AnimateWindow","UInt",GUI_ID,"Int",50,"UInt","0xa0000")    ;;∙------∙Fade-In (1/20 second). (not great)
Return
...
Gui, +AlwaysOnTop +LastFound
        -E0x02000000 -E0x00080000    ;;∙------∙Double Buffer to reduce Gui redraw flicker.
  DllCall("AnimateWindow","UInt",GUI_ID,"Int",1500,"UInt","0x90000")    ;;∙------∙Fade-Out (1.5 seconds) on GUI Close.
  ExitApp
