...
» SOURCE :  https://www.autohotkey.com/boards/viewtopic.php?style=2&t=21499#p225052
» Detect when Mouse Cursor leaves Script's Gui.
∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙ 
;∙---------------------- NOTES END ----------------------------------------∙ 
*/
; ∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙=∙ 
...
;;------------------------------------------
WM_LBUTTONDOWNdrag() {  ;;---Gui Drag Pt.2 --- (keep towards script end)
